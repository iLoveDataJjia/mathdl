...
\begin{proposition}
  {\normalfont
    $\mathcal{R} = (\mathcal{R}_1 \ldots \mathcal{R}_m) \in \mathcal{D}(\Real^m,\Real^m)$ and its jacobian is \begin{equation}
      \begin{array}{llll}
...
\begin{proposition}
  {\normalfont
    ...
    $\mathbb{L}(y,w^{(1)},\ldots,w^{(i^*-1)},\cdot,w^{(i^*)},\ldots,w^{(m-1)},b) \in \mathcal{D}(\Real^n, \Real^m)$
    ...
    \begin{equation} \label{prop:densel_W_differential}
      ...
      \end{array}
    \end{equation} \par
    \textbf{Note:} For $i^*=1$ or $i^*=m$,
    the applications $\mathbb{L}(y,\cdot,w^{(1)},\ldots,w^{(m-1)},b)$ or $\mathbb{L}(y,w^{(1)},\ldots,w^{(m-1)},\cdot,b)$ are meant respectively.
  }
\end{proposition}

\begin{proof}
  Let $y \in \Real^n$, $(w^{(k)})_{k \in \llbracket 1,m-1 \rrbracket} \in (\Real^n)^{m-1}$, $b \in \Real^m$,
  $i^* \in \llbracket 1,m \rrbracket$, $i \in \llbracket 1,m \rrbracket$, $j \in \llbracket 1,n \rrbracket$ and $w \in \Real^n$. \begin{equation*}
    \begin{gathered}
...
\begin{definition}
  ...
  \textit{Multi-class dense neural network} noted as $\mathcal{N}_{c^+}$ be \begin{equation*}
    \begin{array}{llll}
      \mathcal{N}_{c^+} & : & \Real^{m_0} \times ( \underset{k=1}{\overset{p}{\times}} \mathcal{M}_{m_{k},m_{k-1}} \times \Real^{m_{k}} ) & \longrightarrow \Real^{m_p} \\
  ...
  \textbf{Note:} $\mathcal{N}_{c^+} : \Real^{m_0} \times ( \underset{k=1}{\overset{p}{\times}} \mathcal{M}_{m_{k},m_{k-1}} \times \Real^{m_{k}} )
    \longrightarrow \Real^{m_p}$
  is equivalent to $\mathcal{N}_{c^+} : \Real^{m_0} \times ( \underset{k=1}{\overset{p}{\times}} (\Real^{m_{k-1}})^{m_k} \times \Real^{m_{k}} )
  \longrightarrow \Real^{m_p}$.
\end{definition}
...
\begin{corollary}
  \normalfont{
    Let $(m_k)_{k \in \llbracket 0,p \rrbracket}$ and $\mathcal{N}_{c^+} \in
      \mathcal{F}_{net}(\Real^{m_0} \times ( \underset{k=1}{\overset{p}{\times}} (\Real^{m_{k-1}})^{m_k} \times \Real^{m_{k}} ), \Real^{m_p})$. \par
    $\mathcal{N}_{c^+} \in \mathcal{D}(\Real^{m_0} \times ( \underset{k=1}{\overset{p}{\times}} (\Real^{m_{k-1}})^{m_k} \times \Real^{m_{k}} ), \Real^{m_p})$
...
\begin{definition}
  Let $(m_k)_{k \in \llbracket 0,p \rrbracket}$, $\mathcal{N}_{c^+} \in
    ...
    and $(x,y^*) \in \Real^n \times \Real^m$. \par
...
% Multi-Class DNN objective function differential
\begin{theorem}
  {\normalfont
